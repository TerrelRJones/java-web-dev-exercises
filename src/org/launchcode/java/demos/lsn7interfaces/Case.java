...
public class Case {
    ...
    public Case(){
        ...
        Topping topping1 = new Topping("snickers", 1.50, new ArrayList<>(Arrays.asList("nuts")));
        Topping topping2 = new Topping("butter fingers", 1.00, new ArrayList<>(Arrays.asList("peanut butter")));
        Topping topping3 = new Topping("cookie dough", .75, new ArrayList<>(Arrays.asList("egg", "dairy")));
        Topping topping4 = new Topping("gold flakes", 100.00, new ArrayList<>(Arrays.asList("gold", "dirt")));
        Topping topping5 = new Topping("whip cream", .50, new ArrayList<>(Arrays.asList("dairy")));
